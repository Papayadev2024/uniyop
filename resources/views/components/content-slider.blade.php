<div class="w-full">
  <div class="h-[450px] flex flex-col relative z-20 pt-[35px] lg:pt-[70px] max-w-6xl mx-auto gap-6 lg:gap-8 px-[5%]">
    ...
    <h2 class="text-[#006BF6]  font-normal text-xl lg:text-3xl text-center font-Inter_Regular">{{ $item->botontext1 }}</h2>
    ...
    <div class="flex flex-col items-center justify-center w-full max-w-4xl mx-auto">
      <h3 class="text-lg text-center font-Inter_Regular font-normal leading-snug lg:leading-loose">{{ $item->description }}</h3>
    </div>
